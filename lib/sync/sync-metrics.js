...
var getStats = function(cb) {
  var metricsToFetch = ['cpuUsed', 'rss', METRIC_KEYS.WORKER_JOB_PROCESS_TIME, METRIC_KEYS.WORKER_QUEUE_SIZE, METRIC_KEYS.SYNC_API_PROCESS_TIME];
  var metricsToFetch = [{
