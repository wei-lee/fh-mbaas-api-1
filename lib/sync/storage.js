...
function insertDatasetClient(fields, cb) {
  var col = mongoClient.collection(DATASETCLIENTS_COLLECTION);
  col.insertOne(fields, cb);
}
...
module.exports = function(mongoClientImpl) {
  ...
  return {
    ...
    upsertDatasetClient: function(datasetClientId, fields, callback) {
      ...
      return metrics.timeAsyncFunc(metrics.KEYS.MONGODB_OPERATION_TIME, insertDatasetClient)(fields, true, callback);
    },
